            ...
            <div class="table-responsive">
                <table class="table table-hover table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="4">
                                <img src="https://api.qrserver.com/v1/create-qr-code/?data=https://yourdomain.com/book-details.jsp?id=<%= bs.getBook().getId() %>&size=100x100" alt="QR Code for Book">
                                <p style="color:white;">Scan to view book details</p>
                            </td>
                        </tr>
                        <%
                                }
